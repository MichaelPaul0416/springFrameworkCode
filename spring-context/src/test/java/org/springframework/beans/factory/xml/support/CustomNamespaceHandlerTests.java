...
public class CustomNamespaceHandlerTests {
	...
	public void setUp() throws Exception {
		...
		reader.setValidationMode(XmlBeanDefinitionReader.VALIDATION_XSD);//指定校验的xsd，也就是namespace
	...
	public void testChainedDecorators() throws Exception {
		...
		NopInterceptor nopInterceptor = (NopInterceptor) advisors[1].getAdvice();
		//expected-->2的原因是在assertTrue方法中，调用了被代理的getName(),getAge()
		assertEquals("error number of NopInterceptor",2,nopInterceptor.getCount());
	}
