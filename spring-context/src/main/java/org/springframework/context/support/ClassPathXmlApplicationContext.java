...
public class ClassPathXmlApplicationContext extends AbstractXmlApplicationContext {
	...
	public ClassPathXmlApplicationContext(
		...
		super(parent);//主要是为ApplicationContext设置ResourcePatternResolver--->AbstractApplicationContext#getResourcePatternResolver
		setConfigLocations(configLocations);//将字符串的代表的配置文件路径进行解析
		if (refresh) {
			refresh();
		}
	}
