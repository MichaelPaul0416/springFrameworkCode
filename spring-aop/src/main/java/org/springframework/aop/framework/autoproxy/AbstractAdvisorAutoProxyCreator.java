...
public abstract class AbstractAdvisorAutoProxyCreator extends AbstractAutoProxyCreator {
	...
	protected Object[] getAdvicesAndAdvisorsForBean(
		...
		List<Advisor> advisors = findEligibleAdvisors(beanClass, beanName);//获取合格的advisor
		if (advisors.isEmpty()) {
			return DO_NOT_PROXY;
		}
	...
	protected List<Advisor> findEligibleAdvisors(Class<?> beanClass, String beanName) {
		List<Advisor> candidateAdvisors = findCandidateAdvisors();////获取当前beanfactory中所有合格的advisor，factorybean和正在创建中的bean除外
		List<Advisor> eligibleAdvisors = findAdvisorsThatCanApply(candidateAdvisors, beanClass, beanName);//IntroductionAdvisor
