...
public abstract class AbstractEnvironment implements ConfigurableEnvironment {
	...
	@Override
	public void setActiveProfiles(String... profiles) {//string array --> local param set
	...
	@Override
	@Deprecated
	public boolean acceptsProfiles(String... profiles) {//检查配置的profile是否都是active[spring.profiles.active]的，或者为空的话取默认的profile
