...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
	 ...
	 */
	public int registerBeanDefinitions(Document doc, Resource resource) throws BeanDefinitionStoreException {//从xml转换而来的document对象获取对应的bean定义，然后在解析为beanDefinition并且注册
